...
<figure>
  <img src="../images/atx-bench-supply.svg" alt="ATX PSU block with PS_ON toggle switch wired to ground, dummy load resistor on the +5 V rail, and output rails (+12 V, +5 V, +3.3 V, −12 V, GND) going to labeled binding posts. An optional 470 Ω resistor and LED show PWR_OK status." loading="lazy">
