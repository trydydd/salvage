...
4. Transistor test station (columns 17–25): place three labeled header pins: B, C, and E. For NPN testing, wire the B pin through a 47 kΩ resistor to the red rail, a 1 kΩ resistor from the red rail to the anode of an indicator LED whose cathode connects to the C pin, and the E pin directly to the blue rail. When a working NPN transistor is inserted with its leads matched to B, C, and E, base bias allows current through the collector and the LED lights.
