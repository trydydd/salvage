...
For continuity work and understanding how contact resistance affects circuit behavior, see [DC measurements](/open-circuits/DC/DC_5.html). For quick switch and connector test setups that confirm behavior under real load, see [bench experiments](/open-circuits/Exper/EXP_2.html).
