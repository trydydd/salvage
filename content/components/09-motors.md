...
For safe low-voltage motor checks and understanding current-limited testing, see [DC measurements](/open-circuits/DC/DC_5.html). For basic motor-driving experiments that show you how to get a brushed or stepper motor moving with simple circuits, see [bench experiments](/open-circuits/Exper/EXPER_1.html).
