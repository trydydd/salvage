...
For transistor action and how the base current controls collector current, see [Semiconductors](/open-circuits/Semi/SEMI_6.html). For simple transistor test fixtures you can build at the bench to confirm HFE and switching behavior, see [bench experiments](/open-circuits/Exper/EXP_5.html).
