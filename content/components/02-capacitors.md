...
For charge and discharge behavior and how to observe it with a meter, see [DC measurements](/open-circuits/DC/DC_5.html). For test setups that let you see how a capacitor behaves under real load conditions, see [bench experiments](/open-circuits/Exper/EXPER_1.html).
